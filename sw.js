const CACHE='schoolhub-shell-v5';
const SHELL=['/','/index.html','/style.css','/app.js','/parent-live.js','/teacher-pro.js','/teacher-fix.js','/parent-attachments.js','/admin-pro.js','/parent-pro.js','/calendar-live.js','/notifications-live.js','/pwa-install.js','/push-live.js','/manifest.webmanifest','/icons/schoollink-192.svg','/icons/schoollink-512.svg'];
